...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_video', type=str, required=True, help="Input file")
    parser.add_argument("--output_path", type = str, required = True, help = "Output chart plot")
    parser.add_argument("--chart_name", type = str, required = True, help = "Chart name")
    args = parser.parse_args()
    source = args.input_video
    output_dir = args.output_path
    chart_name = args.chart_name
    anomaly_detect(source = source, output_dir = output_dir, chart_name = chart_name)
